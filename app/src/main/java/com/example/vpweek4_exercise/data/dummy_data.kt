package com.example.vpweek4_exercise.data
...
class dummy_data {
    ...
    fun get_data_tokopedia_category(): List<categories> {
        return listOf(
            ...
            categories(
                image_path = R.drawable.clothing,
                category_name = "Clothing",
                number_of_items = 200
            ),
            categories(
                image_path = R.drawable.furniture,
            ...
            categories(
                image_path = R.drawable.sports,
                category_name = "Sports",
                number_of_items = 80
            ),
            categories(
                image_path = R.drawable.beauty,
